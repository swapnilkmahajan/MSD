...
public class MenuToMyOpportunitiesCompletedTester extends InstrumentationTestCase {
    ...
    public void setUp() throws Exception {
        ...
        device.wait(Until.hasObject(By.text("Completed")), 3000);
        UiObject2 upcomingButton = device.findObject(By.text("Completed"));
        upcomingButton.click();

        device.wait(Until.hasObject(By.text("Career Fair")), 3000);
        UiObject2 opportunity = device.findObject(By.text("Career Fair"));

        device.waitForIdle(3000);
        //  UiObject2 resultText = device.findObject(By.clazz("android.widget.EditText"));
        String result = opportunity.getText();
        assertTrue(result.equals("Career Fair"));
    }
