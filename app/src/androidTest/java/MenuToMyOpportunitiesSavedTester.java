...
public class MenuToMyOpportunitiesSavedTester extends InstrumentationTestCase {
    ...
    public void setUp() throws Exception {
        ...
        device.wait(Until.hasObject(By.text("Saved")), 3000);
        UiObject2 upcomingButton = device.findObject(By.text("Saved"));
        upcomingButton.click();

        device.wait(Until.hasObject(By.text("April Fool Specil Event!")), 3000);
        UiObject2 opportunity = device.findObject(By.text("April Fool Specil Event!"));
        ...
        assertTrue(result.equals("April Fool Specil Event!"));
    }
