...
public class MenuToMyOpportunitiesTester extends InstrumentationTestCase {
    ...
    public void setUp() throws Exception {
        ...
        device.wait(Until.hasObject(By.text("In Progress")), 3000);
        UiObject2 inProgressButton = device.findObject(By.text("In Progress"));


        device.waitForIdle(6000);
        //  UiObject2 resultText = device.findObject(By.clazz("android.widget.EditText"));
        String result = inProgressButton.getText();
