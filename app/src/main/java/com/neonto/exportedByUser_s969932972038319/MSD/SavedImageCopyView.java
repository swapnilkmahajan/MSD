...
public class SavedImageCopyView extends FrameLayout {
    ...
    public SavedImageCopyView(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public SavedImageCopyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public SavedImageCopyView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.saved_image_copy);
