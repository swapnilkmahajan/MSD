...
public class OppDetail3BackgroundShapeView extends View {



    public OppDetail3BackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public OppDetail3BackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public OppDetail3BackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
