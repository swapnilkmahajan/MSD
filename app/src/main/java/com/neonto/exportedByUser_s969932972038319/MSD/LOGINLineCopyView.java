...
public class LOGINLineCopyView extends View {



    public LOGINLineCopyView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public LOGINLineCopyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public LOGINLineCopyView(Context context, AttributeSet attrs, int defStyle) {
