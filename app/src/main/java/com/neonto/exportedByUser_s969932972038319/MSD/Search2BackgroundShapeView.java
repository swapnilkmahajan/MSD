...
public class Search2BackgroundShapeView extends View {



    public Search2BackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public Search2BackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public Search2BackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
