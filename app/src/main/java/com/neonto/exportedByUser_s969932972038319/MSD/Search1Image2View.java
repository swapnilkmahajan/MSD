...
public class Search1Image2View extends FrameLayout {
    ...
    public Search1Image2View(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public Search1Image2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public Search1Image2View(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.search1_image2);
