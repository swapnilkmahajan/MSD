...
public class REGISTERLineView extends View {



    public REGISTERLineView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public REGISTERLineView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public REGISTERLineView(Context context, AttributeSet attrs, int defStyle) {
