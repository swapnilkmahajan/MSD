...
public class MyOppImage2View extends FrameLayout {
    ...
    public MyOppImage2View(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public MyOppImage2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public MyOppImage2View(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.my_opp_image2);
