...
public class CompletedImageView extends FrameLayout {



    private ImageView m_image;
    // This value represents scaling applied to the image by Neonto Studio on export.
    private float m_contentOriginalScale = 0.364800000f;
    

    private boolean m_imageOverriden = false;

    public CompletedImageView(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public CompletedImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public CompletedImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.completed_image);
