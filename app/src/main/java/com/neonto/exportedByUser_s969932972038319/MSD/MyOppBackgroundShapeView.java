...
public class MyOppBackgroundShapeView extends View {



    public MyOppBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public MyOppBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public MyOppBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
