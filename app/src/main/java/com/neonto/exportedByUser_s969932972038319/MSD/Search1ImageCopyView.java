...
public class Search1ImageCopyView extends FrameLayout {



    private ImageView m_image;
    // This value represents scaling applied to the image by Neonto Studio on export.
    private float m_contentOriginalScale = 0.481914894f;
    

    private boolean m_imageOverriden = false;

    public Search1ImageCopyView(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public Search1ImageCopyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public Search1ImageCopyView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.search1_image_copy);
