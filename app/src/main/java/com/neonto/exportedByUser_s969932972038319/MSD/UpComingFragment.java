...
public class UpComingFragment extends Fragment {
    ...
    private UpComingBackgroundShapeView mBackgroundShape;
    private UpComingImageView mImage;
    ...
    private UpComingImage2View mImage2;
    ...
    public UpComingFragment() {  // fragment must have a constructor
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBackgroundShape = (UpComingBackgroundShapeView) rootView.findViewById(R.id.mBackgroundShape);
        mImage = (UpComingImageView) rootView.findViewById(R.id.mImage);
        ...
        mImage2 = (UpComingImage2View) rootView.findViewById(R.id.mImage2);
        ...
        final UpComingFragment fragment = this;
    ...
    private void repositionElements() {
        ...
        layoutDescs_mImage.add(new LayoutDesc(10, 0.0f, 230.0f, LayoutDesc.NO_VALUE, 723.0f, 332.0f));  // 720*1280 px
        layoutDescs_mImage.add(new LayoutDesc(2, 0.0f, 100.0f, LayoutDesc.NO_VALUE, 315.0f, 145.0f));  // 240*320 px
        layoutDescs_mImage.add(new LayoutDesc(12, 0.0f, 291.0f, LayoutDesc.NO_VALUE, 912.0f, 419.0f));  // 1080*1920 px
        layoutDescs_mImage.add(new LayoutDesc(8, 0.0f, 163.0f, LayoutDesc.NO_VALUE, 513.0f, 236.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mImage.get(0).offsetInFlow = 230.48f;
        layoutDescs_mImage.get(1).offsetInFlow = 100.18f;
        layoutDescs_mImage.get(2).offsetInFlow = 290.70f;
        layoutDescs_mImage.get(3).offsetInFlow = 163.44f;
        applyLayoutToView(mImage, dm, layoutDescs_mImage, true, true);

        ArrayList<LayoutDesc> layoutDescs_mText6 = new ArrayList<LayoutDesc>();
        layoutDescs_mText6.add(new LayoutDesc(10, 41.0f, 562.0f, LayoutDesc.NO_VALUE, 446.29f, 45.0f));  // 720*1280 px
        layoutDescs_mText6.add(new LayoutDesc(2, 18.0f, 245.0f, LayoutDesc.NO_VALUE, 193.98f, 24.0f));  // 240*320 px
        layoutDescs_mText6.add(new LayoutDesc(12, 52.0f, 711.0f, LayoutDesc.NO_VALUE, 562.90f, 55.0f));  // 1080*1920 px
        layoutDescs_mText6.add(new LayoutDesc(8, 29.0f, 399.0f, LayoutDesc.NO_VALUE, 316.48f, 34.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText6.get(0).offsetInFlow = 0.46f;
        layoutDescs_mText6.get(1).offsetInFlow = 0.20f;
        layoutDescs_mText6.get(2).offsetInFlow = 0.58f;
        layoutDescs_mText6.get(3).offsetInFlow = 0.32f;
        ...
        layoutDescs_mText7.add(new LayoutDesc(10, 38.0f, 599.0f, LayoutDesc.NO_VALUE, 642.64f, 56.0f));  // 720*1280 px
        layoutDescs_mText7.add(new LayoutDesc(2, 16.0f, 262.0f, LayoutDesc.NO_VALUE, 279.33f, 28.0f));  // 240*320 px
        layoutDescs_mText7.add(new LayoutDesc(12, 48.0f, 758.0f, LayoutDesc.NO_VALUE, 810.56f, 70.0f));  // 1080*1920 px
        layoutDescs_mText7.add(new LayoutDesc(8, 27.0f, 426.0f, LayoutDesc.NO_VALUE, 455.73f, 41.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText7.get(0).offsetInFlow = -1.86f;
        layoutDescs_mText7.get(1).offsetInFlow = -0.81f;
        layoutDescs_mText7.get(2).offsetInFlow = -2.34f;
        layoutDescs_mText7.get(3).offsetInFlow = -1.32f;
        ...
        layoutDescs_mText8.add(new LayoutDesc(10, 42.0f, 647.0f, LayoutDesc.NO_VALUE, 446.29f, 45.0f));  // 720*1280 px
        layoutDescs_mText8.add(new LayoutDesc(2, 18.0f, 283.0f, LayoutDesc.NO_VALUE, 193.98f, 24.0f));  // 240*320 px
        layoutDescs_mText8.add(new LayoutDesc(12, 53.0f, 820.0f, LayoutDesc.NO_VALUE, 562.90f, 55.0f));  // 1080*1920 px
        layoutDescs_mText8.add(new LayoutDesc(8, 30.0f, 460.0f, LayoutDesc.NO_VALUE, 316.48f, 34.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText8.get(0).offsetInFlow = -1.75f;
        layoutDescs_mText8.get(1).offsetInFlow = -0.76f;
        layoutDescs_mText8.get(2).offsetInFlow = -2.21f;
        layoutDescs_mText8.get(3).offsetInFlow = -1.24f;
        applyLayoutToView(mText8, dm, layoutDescs_mText8, true, false);

        ArrayList<LayoutDesc> layoutDescs_mText = new ArrayList<LayoutDesc>();
        layoutDescs_mText.add(new LayoutDesc(10, 546.0f, 655.0f, LayoutDesc.NO_VALUE, 446.29f, 45.0f));  // 720*1280 px
        layoutDescs_mText.add(new LayoutDesc(2, 237.0f, 287.0f, LayoutDesc.NO_VALUE, 193.98f, 24.0f));  // 240*320 px
        layoutDescs_mText.add(new LayoutDesc(12, 688.0f, 830.0f, LayoutDesc.NO_VALUE, 562.90f, 55.0f));  // 1080*1920 px
        layoutDescs_mText.add(new LayoutDesc(8, 387.0f, 466.0f, LayoutDesc.NO_VALUE, 316.48f, 34.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText.get(0).offsetInFlow = -31.29f;
        layoutDescs_mText.get(1).offsetInFlow = -13.6f;
        layoutDescs_mText.get(2).offsetInFlow = -39.46f;
        layoutDescs_mText.get(3).offsetInFlow = -22.19f;
        ...
        layoutDescs_mHotspot.add(new LayoutDesc(10, -9.0f, 235.0f, LayoutDesc.NO_VALUE, 735.53f, 471.45f));  // 720*1280 px
        layoutDescs_mHotspot.add(new LayoutDesc(2, -4.0f, 106.0f, LayoutDesc.NO_VALUE, 319.70f, 204.92f));  // 240*320 px
        layoutDescs_mHotspot.add(new LayoutDesc(12, -11.0f, 301.0f, LayoutDesc.NO_VALUE, 927.72f, 594.64f));  // 1080*1920 px
        layoutDescs_mHotspot.add(new LayoutDesc(8, -6.0f, 169.0f, LayoutDesc.NO_VALUE, 521.60f, 334.33f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mHotspot.get(0).offsetInFlow = -458.61f;
        layoutDescs_mHotspot.get(1).offsetInFlow = -199.34f;
        layoutDescs_mHotspot.get(2).offsetInFlow = -578.45f;
        layoutDescs_mHotspot.get(3).offsetInFlow = -325.23f;
        ...
        layoutDescs_mFixedButton.add(new LayoutDesc(10, 254.0f, 1300.45f, LayoutDesc.NO_VALUE, 212.52f, 63.76f));  // 720*1280 px
        layoutDescs_mFixedButton.add(new LayoutDesc(2, 111.0f, 568.92f, LayoutDesc.NO_VALUE, 92.37f, 27.71f));  // 240*320 px
        layoutDescs_mFixedButton.add(new LayoutDesc(12, 321.0f, 1644.64f, LayoutDesc.NO_VALUE, 268.05f, 80.41f));  // 1080*1920 px
        layoutDescs_mFixedButton.add(new LayoutDesc(8, 180.0f, 924.33f, LayoutDesc.NO_VALUE, 150.71f, 45.21f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mFixedButton.get(0).offsetInFlow = 593.89f;
        layoutDescs_mFixedButton.get(1).offsetInFlow = 258.14f;
        layoutDescs_mFixedButton.get(2).offsetInFlow = 749.07f;
        layoutDescs_mFixedButton.get(3).offsetInFlow = 421.16f;
        ...
        layoutDescs_mText2.add(new LayoutDesc(10, 167.0f, 37.0f, LayoutDesc.NO_VALUE, 548.91f, 63.0f));  // 720*1280 px
        layoutDescs_mText2.add(new LayoutDesc(2, 73.0f, 16.0f, LayoutDesc.NO_VALUE, 238.58f, 30.0f));  // 240*320 px
        layoutDescs_mText2.add(new LayoutDesc(12, 211.0f, 48.0f, LayoutDesc.NO_VALUE, 692.34f, 77.0f));  // 1080*1920 px
        layoutDescs_mText2.add(new LayoutDesc(8, 119.0f, 26.0f, LayoutDesc.NO_VALUE, 389.26f, 46.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
