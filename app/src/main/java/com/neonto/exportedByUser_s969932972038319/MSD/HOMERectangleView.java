...
public class HOMERectangleView extends View {



    public HOMERectangleView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public HOMERectangleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public HOMERectangleView(Context context, AttributeSet attrs, int defStyle) {
