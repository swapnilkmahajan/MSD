...
public class CompletedBackgroundShapeView extends View {



    public CompletedBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public CompletedBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public CompletedBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
