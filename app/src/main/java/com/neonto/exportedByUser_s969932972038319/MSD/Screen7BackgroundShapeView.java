...
public class Screen7BackgroundShapeView extends View {



    public Screen7BackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public Screen7BackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public Screen7BackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
