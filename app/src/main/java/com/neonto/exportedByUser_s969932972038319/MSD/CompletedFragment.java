...
public class CompletedFragment extends Fragment {
    ...
    private CompletedBackgroundShapeView mBackgroundShape;
    private CompletedImageView mImage;
    ...
    private CompletedImage2View mImage2;
    ...
    public CompletedFragment() {  // fragment must have a constructor
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBackgroundShape = (CompletedBackgroundShapeView) rootView.findViewById(R.id.mBackgroundShape);
        mImage = (CompletedImageView) rootView.findViewById(R.id.mImage);
        ...
        mImage2 = (CompletedImage2View) rootView.findViewById(R.id.mImage2);
        ...
        final CompletedFragment fragment = this;
    ...
    private void repositionElements() {
        ...
        layoutDescs_mImage.add(new LayoutDesc(10, 0.0f, 232.0f, LayoutDesc.NO_VALUE, 723.0f, 332.0f));  // 720*1280 px
        layoutDescs_mImage.add(new LayoutDesc(2, 0.0f, 101.0f, LayoutDesc.NO_VALUE, 315.0f, 145.0f));  // 240*320 px
        layoutDescs_mImage.add(new LayoutDesc(12, 0.0f, 292.0f, LayoutDesc.NO_VALUE, 912.0f, 419.0f));  // 1080*1920 px
        layoutDescs_mImage.add(new LayoutDesc(8, 0.0f, 164.0f, LayoutDesc.NO_VALUE, 513.0f, 236.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mImage.get(0).offsetInFlow = 231.78f;
        layoutDescs_mImage.get(1).offsetInFlow = 100.74f;
        layoutDescs_mImage.get(2).offsetInFlow = 292.34f;
        layoutDescs_mImage.get(3).offsetInFlow = 164.36f;
        applyLayoutToView(mImage, dm, layoutDescs_mImage, true, true);

        ArrayList<LayoutDesc> layoutDescs_mText2 = new ArrayList<LayoutDesc>();
        layoutDescs_mText2.add(new LayoutDesc(10, 38.0f, 564.0f, LayoutDesc.NO_VALUE, 446.29f, 45.0f));  // 720*1280 px
        layoutDescs_mText2.add(new LayoutDesc(2, 17.0f, 246.0f, LayoutDesc.NO_VALUE, 193.98f, 24.0f));  // 240*320 px
        layoutDescs_mText2.add(new LayoutDesc(12, 48.0f, 712.0f, LayoutDesc.NO_VALUE, 562.90f, 55.0f));  // 1080*1920 px
        layoutDescs_mText2.add(new LayoutDesc(8, 27.0f, 400.0f, LayoutDesc.NO_VALUE, 316.48f, 34.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText3.add(new LayoutDesc(10, 41.0f, 602.0f, LayoutDesc.NO_VALUE, 446.29f, 56.0f));  // 720*1280 px
        layoutDescs_mText3.add(new LayoutDesc(2, 18.0f, 263.0f, LayoutDesc.NO_VALUE, 193.98f, 28.0f));  // 240*320 px
        layoutDescs_mText3.add(new LayoutDesc(12, 51.0f, 759.0f, LayoutDesc.NO_VALUE, 562.90f, 70.0f));  // 1080*1920 px
        layoutDescs_mText3.add(new LayoutDesc(8, 29.0f, 427.0f, LayoutDesc.NO_VALUE, 316.48f, 41.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText5.add(new LayoutDesc(10, 42.0f, 649.0f, LayoutDesc.NO_VALUE, 633.45f, 84.0f));  // 720*1280 px
        layoutDescs_mText5.add(new LayoutDesc(2, 18.0f, 284.0f, LayoutDesc.NO_VALUE, 275.33f, 42.0f));  // 240*320 px
        layoutDescs_mText5.add(new LayoutDesc(12, 53.0f, 819.0f, LayoutDesc.NO_VALUE, 798.97f, 104.0f));  // 1080*1920 px
        layoutDescs_mText5.add(new LayoutDesc(8, 30.0f, 460.0f, LayoutDesc.NO_VALUE, 449.21f, 62.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText4.add(new LayoutDesc(10, 548.0f, 695.0f, LayoutDesc.NO_VALUE, 446.29f, 45.0f));  // 720*1280 px
        layoutDescs_mText4.add(new LayoutDesc(2, 238.0f, 306.0f, LayoutDesc.NO_VALUE, 193.98f, 24.0f));  // 240*320 px
        layoutDescs_mText4.add(new LayoutDesc(12, 692.0f, 877.0f, LayoutDesc.NO_VALUE, 562.90f, 55.0f));  // 1080*1920 px
        layoutDescs_mText4.add(new LayoutDesc(8, 389.0f, 493.0f, LayoutDesc.NO_VALUE, 316.48f, 34.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mHotspot.add(new LayoutDesc(10, -13.0f, 228.0f, LayoutDesc.NO_VALUE, 748.06f, 521.28f));  // 720*1280 px
        layoutDescs_mHotspot.add(new LayoutDesc(2, -6.0f, 104.0f, LayoutDesc.NO_VALUE, 325.14f, 226.57f));  // 240*320 px
        layoutDescs_mHotspot.add(new LayoutDesc(12, -16.0f, 288.0f, LayoutDesc.NO_VALUE, 943.52f, 657.49f));  // 1080*1920 px
        layoutDescs_mHotspot.add(new LayoutDesc(8, -9.0f, 162.0f, LayoutDesc.NO_VALUE, 530.49f, 369.67f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mHotspot.get(0).offsetInFlow = -505.58f;
        layoutDescs_mHotspot.get(1).offsetInFlow = -219.75f;
        layoutDescs_mHotspot.get(2).offsetInFlow = -637.68f;
        layoutDescs_mHotspot.get(3).offsetInFlow = -358.53f;
        ...
        layoutDescs_mFixedButton.add(new LayoutDesc(10, 237.0f, 1298.28f, LayoutDesc.NO_VALUE, 212.52f, 63.76f));  // 720*1280 px
        layoutDescs_mFixedButton.add(new LayoutDesc(2, 103.0f, 569.57f, LayoutDesc.NO_VALUE, 92.37f, 27.71f));  // 240*320 px
        layoutDescs_mFixedButton.add(new LayoutDesc(12, 298.0f, 1638.49f, LayoutDesc.NO_VALUE, 268.05f, 80.41f));  // 1080*1920 px
        layoutDescs_mFixedButton.add(new LayoutDesc(8, 168.0f, 921.67f, LayoutDesc.NO_VALUE, 150.71f, 45.21f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mFixedButton.get(0).offsetInFlow = 549.38f;
        layoutDescs_mFixedButton.get(1).offsetInFlow = 238.79f;
        layoutDescs_mFixedButton.get(2).offsetInFlow = 692.93f;
        layoutDescs_mFixedButton.get(3).offsetInFlow = 389.60f;
