...
public class Search2Image2View extends FrameLayout {
    ...
    public Search2Image2View(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public Search2Image2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public Search2Image2View(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.search2_image2);
