...
public class EditInfoBackgroundShapeView extends View {



    public EditInfoBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public EditInfoBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public EditInfoBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
