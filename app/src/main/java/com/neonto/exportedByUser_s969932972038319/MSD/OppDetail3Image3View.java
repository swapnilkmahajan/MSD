...
public class OppDetail3Image3View extends FrameLayout {
    ...
    public OppDetail3Image3View(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public OppDetail3Image3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public OppDetail3Image3View(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.opp_detail3_image3);
