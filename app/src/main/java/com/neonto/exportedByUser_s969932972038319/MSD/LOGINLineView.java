...
public class LOGINLineView extends View {
    ...
    public LOGINLineView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public LOGINLineView(Context context, AttributeSet attrs, int defStyle) {
