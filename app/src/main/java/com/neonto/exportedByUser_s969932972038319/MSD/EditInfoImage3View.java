...
public class EditInfoImage3View extends FrameLayout {
    ...
    public EditInfoImage3View(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public EditInfoImage3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public EditInfoImage3View(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.edit_info_image3);
