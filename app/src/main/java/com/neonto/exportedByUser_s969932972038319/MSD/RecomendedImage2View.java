...
public class RecomendedImage2View extends FrameLayout {
    ...
    public RecomendedImage2View(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public RecomendedImage2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public RecomendedImage2View(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.recomended_image2);
