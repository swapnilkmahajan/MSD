...
public class OppDeatil0Image2View extends FrameLayout {
    ...
    public OppDeatil0Image2View(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public OppDeatil0Image2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public OppDeatil0Image2View(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.opp_deatil0_image2);
