...
public class MyInfoBackgroundShapeView extends View {



    public MyInfoBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public MyInfoBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public MyInfoBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
