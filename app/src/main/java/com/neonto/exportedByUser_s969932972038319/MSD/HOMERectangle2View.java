...
public class HOMERectangle2View extends View {



    public HOMERectangle2View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public HOMERectangle2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public HOMERectangle2View(Context context, AttributeSet attrs, int defStyle) {
