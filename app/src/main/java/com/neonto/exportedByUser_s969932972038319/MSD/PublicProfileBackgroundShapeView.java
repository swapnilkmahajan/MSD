...
public class PublicProfileBackgroundShapeView extends View {



    public PublicProfileBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public PublicProfileBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public PublicProfileBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
