...
public class OppDetail2BackgroundShapeView extends View {



    public OppDetail2BackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public OppDetail2BackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public OppDetail2BackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
