...
public class MyInfoImage2View extends FrameLayout {
    ...
    public MyInfoImage2View(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public MyInfoImage2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public MyInfoImage2View(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.my_info_image2);
