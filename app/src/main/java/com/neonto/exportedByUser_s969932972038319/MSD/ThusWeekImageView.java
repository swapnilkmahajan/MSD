...
public class ThusWeekImageView extends FrameLayout {
    ...
    public ThusWeekImageView(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public ThusWeekImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public ThusWeekImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.thus_week_image);
