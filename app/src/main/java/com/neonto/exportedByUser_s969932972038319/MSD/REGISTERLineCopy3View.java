...
public class REGISTERLineCopy3View extends View {



    public REGISTERLineCopy3View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public REGISTERLineCopy3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public REGISTERLineCopy3View(Context context, AttributeSet attrs, int defStyle) {
