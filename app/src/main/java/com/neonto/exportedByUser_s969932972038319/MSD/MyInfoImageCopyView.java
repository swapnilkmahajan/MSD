...
public class MyInfoImageCopyView extends FrameLayout {
    ...
    public MyInfoImageCopyView(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public MyInfoImageCopyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public MyInfoImageCopyView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.my_info_image_copy);
