...
public class RecomendedRectangleView extends View {



    public RecomendedRectangleView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public RecomendedRectangleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public RecomendedRectangleView(Context context, AttributeSet attrs, int defStyle) {
