...
public class OppDetail1ImageView extends FrameLayout {
    ...
    public OppDetail1ImageView(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public OppDetail1ImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public OppDetail1ImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.opp_detail1_image);
