...
public class REGISTERBackgroundShapeView extends View {



    public REGISTERBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public REGISTERBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public REGISTERBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
