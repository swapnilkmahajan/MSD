...
public class UpComingImageView extends FrameLayout {
    ...
    public UpComingImageView(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public UpComingImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public UpComingImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.up_coming_image);
