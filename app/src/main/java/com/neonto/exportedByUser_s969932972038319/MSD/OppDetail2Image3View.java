...
public class OppDetail2Image3View extends FrameLayout {



    private ImageView m_image;
    // This value represents scaling applied to the image by Neonto Studio on export.
    private float m_contentOriginalScale = 0.251034483f;
    

    private boolean m_imageOverriden = false;

    public OppDetail2Image3View(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public OppDetail2Image3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public OppDetail2Image3View(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.opp_detail2_image3);
