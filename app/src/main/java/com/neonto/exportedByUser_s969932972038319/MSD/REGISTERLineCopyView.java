...
public class REGISTERLineCopyView extends View {



    public REGISTERLineCopyView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public REGISTERLineCopyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public REGISTERLineCopyView(Context context, AttributeSet attrs, int defStyle) {
