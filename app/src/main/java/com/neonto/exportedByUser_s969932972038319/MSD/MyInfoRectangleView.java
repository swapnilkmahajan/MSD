...
public class MyInfoRectangleView extends View {



    public MyInfoRectangleView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public MyInfoRectangleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public MyInfoRectangleView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.scale(m_realLayoutWidthInPx/643.0f, m_realLayoutHeightInPx/91.0f);
        canvas.translate(321.5f, 45.5f);
        path = new Path();
        path.moveTo(-321.5f, -45.5f);
          path.lineTo(321.5f, -45.5f);
        path.lineTo(321.5f, 45.5f);
        path.lineTo(-321.5f, 45.5f);
