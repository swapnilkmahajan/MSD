...
public class UpComingBackgroundShapeView extends View {



    public UpComingBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public UpComingBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public UpComingBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
