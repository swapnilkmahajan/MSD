...
public class HOMEImage4View extends FrameLayout {
    ...
    public HOMEImage4View(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public HOMEImage4View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public HOMEImage4View(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.h_o_m_e_image4);
