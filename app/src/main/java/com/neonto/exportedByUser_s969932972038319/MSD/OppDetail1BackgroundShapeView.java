...
public class OppDetail1BackgroundShapeView extends View {



    public OppDetail1BackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public OppDetail1BackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public OppDetail1BackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
