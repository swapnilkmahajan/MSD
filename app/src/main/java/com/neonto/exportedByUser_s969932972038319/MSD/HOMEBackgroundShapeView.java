...
public class HOMEBackgroundShapeView extends View {



    public HOMEBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public HOMEBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public HOMEBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
