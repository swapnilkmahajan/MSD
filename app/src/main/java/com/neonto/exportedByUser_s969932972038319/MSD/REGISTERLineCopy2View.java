...
public class REGISTERLineCopy2View extends View {



    public REGISTERLineCopy2View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public REGISTERLineCopy2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public REGISTERLineCopy2View(Context context, AttributeSet attrs, int defStyle) {
