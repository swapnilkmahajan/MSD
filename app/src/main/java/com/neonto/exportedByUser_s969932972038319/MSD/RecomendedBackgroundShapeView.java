...
public class RecomendedBackgroundShapeView extends View {



    public RecomendedBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public RecomendedBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public RecomendedBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
