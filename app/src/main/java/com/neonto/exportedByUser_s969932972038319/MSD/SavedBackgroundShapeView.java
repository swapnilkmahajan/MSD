...
public class SavedBackgroundShapeView extends View {



    public SavedBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SavedBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SavedBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
