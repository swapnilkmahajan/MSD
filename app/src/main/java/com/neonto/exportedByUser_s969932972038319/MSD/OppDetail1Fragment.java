...
public class OppDetail1Fragment extends Fragment {
    ...
    private void repositionElements() {
        ...
        layoutDescs_mImage.add(new LayoutDesc(10, 0.0f, 155.0f, LayoutDesc.NO_VALUE, 725.0f, 332.0f));  // 720*1280 px
        layoutDescs_mImage.add(new LayoutDesc(2, 0.0f, 67.0f, LayoutDesc.NO_VALUE, 315.0f, 145.0f));  // 240*320 px
        layoutDescs_mImage.add(new LayoutDesc(12, 0.0f, 196.0f, LayoutDesc.NO_VALUE, 914.0f, 419.0f));  // 1080*1920 px
        layoutDescs_mImage.add(new LayoutDesc(8, 0.0f, 110.0f, LayoutDesc.NO_VALUE, 514.0f, 236.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mImage.get(0).contentTransformMatricesString = "[0.457931034, 0.0, 0.0, 0.457931034, -85.814482759, 0.0]; [0.457931034, 0.0, 0.0, 0.457931034, -85.814482759, 0.0]";
        layoutDescs_mImage.get(1).contentTransformMatricesString = "[0.2, 0.0, 0.0, 0.2, -38.3, 0.0]; [0.2, 0.0, 0.0, 0.2, -38.3, 0.0]";
        layoutDescs_mImage.get(2).contentTransformMatricesString = "[0.577931034, 0.0, 0.0, 0.577931034, -108.794482759, 0.0]; [0.577931034, 0.0, 0.0, 0.577931034, -108.794482759, 0.0]";
        layoutDescs_mImage.get(3).contentTransformMatricesString = "[0.325517241, 0.0, 0.0, 0.325517241, -61.681379310, 0.0]; [0.325517241, 0.0, 0.0, 0.325517241, -61.681379310, 0.0]";
        ...
        layoutDescs_mText2.add(new LayoutDesc(10, 42.0f, 488.0f, LayoutDesc.NO_VALUE, 686.47f, 51.0f));  // 720*1280 px
        layoutDescs_mText2.add(new LayoutDesc(2, 18.0f, 213.0f, LayoutDesc.NO_VALUE, 298.37f, 25.0f));  // 240*320 px
        layoutDescs_mText2.add(new LayoutDesc(12, 53.0f, 617.0f, LayoutDesc.NO_VALUE, 865.84f, 63.0f));  // 1080*1920 px
        layoutDescs_mText2.add(new LayoutDesc(8, 30.0f, 347.0f, LayoutDesc.NO_VALUE, 486.81f, 38.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText3.add(new LayoutDesc(10, 41.0f, 533.0f, LayoutDesc.NO_VALUE, 683.07f, 63.0f));  // 720*1280 px
        layoutDescs_mText3.add(new LayoutDesc(2, 18.0f, 232.0f, LayoutDesc.NO_VALUE, 296.90f, 30.0f));  // 240*320 px
        layoutDescs_mText3.add(new LayoutDesc(12, 51.0f, 674.0f, LayoutDesc.NO_VALUE, 861.55f, 77.0f));  // 1080*1920 px
        layoutDescs_mText3.add(new LayoutDesc(8, 29.0f, 379.0f, LayoutDesc.NO_VALUE, 484.40f, 46.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText4.add(new LayoutDesc(10, 32.0f, 590.0f, LayoutDesc.NO_VALUE, 646.12f, 186.0f));  // 720*1280 px
        layoutDescs_mText4.add(new LayoutDesc(2, 14.0f, 256.0f, LayoutDesc.NO_VALUE, 280.83f, 82.0f));  // 240*320 px
        layoutDescs_mText4.add(new LayoutDesc(12, 40.0f, 745.0f, LayoutDesc.NO_VALUE, 814.94f, 234.0f));  // 1080*1920 px
        layoutDescs_mText4.add(new LayoutDesc(8, 23.0f, 419.0f, LayoutDesc.NO_VALUE, 458.19f, 134.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText5.add(new LayoutDesc(10, 38.0f, 770.0f, LayoutDesc.NO_VALUE, 446.29f, 96.0f));  // 720*1280 px
        layoutDescs_mText5.add(new LayoutDesc(2, 16.0f, 332.0f, LayoutDesc.NO_VALUE, 193.98f, 44.0f));  // 240*320 px
        layoutDescs_mText5.add(new LayoutDesc(12, 47.0f, 973.0f, LayoutDesc.NO_VALUE, 562.90f, 120.0f));  // 1080*1920 px
        layoutDescs_mText5.add(new LayoutDesc(8, 27.0f, 547.0f, LayoutDesc.NO_VALUE, 316.48f, 70.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mMap.add(new LayoutDesc(10, 177.0f, 860.0f, LayoutDesc.NO_VALUE, 366.46f, 344.66f));  // 720*1280 px
        layoutDescs_mMap.add(new LayoutDesc(2, 77.0f, 370.0f, LayoutDesc.NO_VALUE, 159.28f, 149.81f));  // 240*320 px
        layoutDescs_mMap.add(new LayoutDesc(12, 223.0f, 1087.0f, LayoutDesc.NO_VALUE, 462.21f, 434.72f));  // 1080*1920 px
        layoutDescs_mMap.add(new LayoutDesc(8, 125.0f, 611.0f, LayoutDesc.NO_VALUE, 259.87f, 244.42f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText6.add(new LayoutDesc(10, 41.0f, 1216.66f, LayoutDesc.NO_VALUE, 640.43f, 186.0f));  // 720*1280 px
        layoutDescs_mText6.add(new LayoutDesc(2, 18.0f, 524.81f, LayoutDesc.NO_VALUE, 278.36f, 82.0f));  // 240*320 px
        layoutDescs_mText6.add(new LayoutDesc(12, 52.0f, 1536.72f, LayoutDesc.NO_VALUE, 807.77f, 234.0f));  // 1080*1920 px
        layoutDescs_mText6.add(new LayoutDesc(8, 29.0f, 863.42f, LayoutDesc.NO_VALUE, 454.16f, 134.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText7.add(new LayoutDesc(10, 39.0f, 1414.66f, LayoutDesc.NO_VALUE, 446.29f, 51.0f));  // 720*1280 px
        layoutDescs_mText7.add(new LayoutDesc(2, 17.0f, 608.81f, LayoutDesc.NO_VALUE, 193.98f, 25.0f));  // 240*320 px
        layoutDescs_mText7.add(new LayoutDesc(12, 50.0f, 1787.72f, LayoutDesc.NO_VALUE, 562.90f, 63.0f));  // 1080*1920 px
        layoutDescs_mText7.add(new LayoutDesc(8, 28.0f, 1004.42f, LayoutDesc.NO_VALUE, 316.48f, 38.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mIconButton3.add(new LayoutDesc(10, 9.0f, 1478.66f, LayoutDesc.NO_VALUE, 59.50f, 51.0f));  // 720*1280 px
        layoutDescs_mIconButton3.add(new LayoutDesc(2, 4.0f, 635.81f, LayoutDesc.NO_VALUE, 25.86f, 22.17f));  // 240*320 px
        layoutDescs_mIconButton3.add(new LayoutDesc(12, 11.0f, 1868.72f, LayoutDesc.NO_VALUE, 75.05f, 64.33f));  // 1080*1920 px
        layoutDescs_mIconButton3.add(new LayoutDesc(8, 6.0f, 1049.42f, LayoutDesc.NO_VALUE, 42.20f, 36.17f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mIconButton4.add(new LayoutDesc(10, 157.0f, 1476.66f, LayoutDesc.NO_VALUE, 59.50f, 51.0f));  // 720*1280 px
        layoutDescs_mIconButton4.add(new LayoutDesc(2, 68.0f, 634.98f, LayoutDesc.NO_VALUE, 25.86f, 22.17f));  // 240*320 px
        layoutDescs_mIconButton4.add(new LayoutDesc(12, 198.0f, 1867.05f, LayoutDesc.NO_VALUE, 75.05f, 64.33f));  // 1080*1920 px
        layoutDescs_mIconButton4.add(new LayoutDesc(8, 111.0f, 1048.58f, LayoutDesc.NO_VALUE, 42.20f, 36.17f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mIconButton5.add(new LayoutDesc(10, 276.0f, 1478.67f, LayoutDesc.NO_VALUE, 59.50f, 51.0f));  // 720*1280 px
        layoutDescs_mIconButton5.add(new LayoutDesc(2, 120.0f, 636.14f, LayoutDesc.NO_VALUE, 25.86f, 22.17f));  // 240*320 px
        layoutDescs_mIconButton5.add(new LayoutDesc(12, 348.0f, 1869.38f, LayoutDesc.NO_VALUE, 75.05f, 64.33f));  // 1080*1920 px
        layoutDescs_mIconButton5.add(new LayoutDesc(8, 196.0f, 1049.75f, LayoutDesc.NO_VALUE, 42.20f, 36.17f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mIconButton6.add(new LayoutDesc(10, 399.0f, 1479.67f, LayoutDesc.NO_VALUE, 59.50f, 51.0f));  // 720*1280 px
        layoutDescs_mIconButton6.add(new LayoutDesc(2, 174.0f, 636.31f, LayoutDesc.NO_VALUE, 25.86f, 22.17f));  // 240*320 px
        layoutDescs_mIconButton6.add(new LayoutDesc(12, 504.0f, 1870.71f, LayoutDesc.NO_VALUE, 75.05f, 64.33f));  // 1080*1920 px
        layoutDescs_mIconButton6.add(new LayoutDesc(8, 283.0f, 1049.92f, LayoutDesc.NO_VALUE, 42.20f, 36.17f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mIconButton7.add(new LayoutDesc(10, 529.0f, 1476.68f, LayoutDesc.NO_VALUE, 59.50f, 51.0f));  // 720*1280 px
        layoutDescs_mIconButton7.add(new LayoutDesc(2, 230.0f, 635.48f, LayoutDesc.NO_VALUE, 25.86f, 22.17f));  // 240*320 px
        layoutDescs_mIconButton7.add(new LayoutDesc(12, 667.0f, 1867.04f, LayoutDesc.NO_VALUE, 75.05f, 64.33f));  // 1080*1920 px
        layoutDescs_mIconButton7.add(new LayoutDesc(8, 375.0f, 1048.09f, LayoutDesc.NO_VALUE, 42.20f, 36.17f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText8.add(new LayoutDesc(10, 0.0f, 1527.68f, LayoutDesc.NO_VALUE, 446.29f, 34.0f));  // 720*1280 px
        layoutDescs_mText8.add(new LayoutDesc(2, 0.0f, 657.65f, LayoutDesc.NO_VALUE, 193.98f, 19.0f));  // 240*320 px
        layoutDescs_mText8.add(new LayoutDesc(12, 0.0f, 1931.37f, LayoutDesc.NO_VALUE, 562.90f, 41.0f));  // 1080*1920 px
        layoutDescs_mText8.add(new LayoutDesc(8, 0.0f, 1084.26f, LayoutDesc.NO_VALUE, 316.48f, 26.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText.add(new LayoutDesc(10, 156.0f, 1526.68f, LayoutDesc.NO_VALUE, 446.29f, 34.0f));  // 720*1280 px
        layoutDescs_mText.add(new LayoutDesc(2, 68.0f, 657.65f, LayoutDesc.NO_VALUE, 193.98f, 19.0f));  // 240*320 px
        layoutDescs_mText.add(new LayoutDesc(12, 197.0f, 1930.37f, LayoutDesc.NO_VALUE, 562.90f, 41.0f));  // 1080*1920 px
        layoutDescs_mText.add(new LayoutDesc(8, 111.0f, 1084.26f, LayoutDesc.NO_VALUE, 316.48f, 26.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText10.add(new LayoutDesc(10, 270.0f, 1526.68f, LayoutDesc.NO_VALUE, 446.29f, 34.0f));  // 720*1280 px
        layoutDescs_mText10.add(new LayoutDesc(2, 117.0f, 658.65f, LayoutDesc.NO_VALUE, 193.98f, 19.0f));  // 240*320 px
        layoutDescs_mText10.add(new LayoutDesc(12, 341.0f, 1929.37f, LayoutDesc.NO_VALUE, 562.90f, 41.0f));  // 1080*1920 px
        layoutDescs_mText10.add(new LayoutDesc(8, 192.0f, 1084.26f, LayoutDesc.NO_VALUE, 316.48f, 26.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText11.add(new LayoutDesc(10, 396.0f, 1527.68f, LayoutDesc.NO_VALUE, 446.29f, 34.0f));  // 720*1280 px
        layoutDescs_mText11.add(new LayoutDesc(2, 172.0f, 659.65f, LayoutDesc.NO_VALUE, 193.98f, 19.0f));  // 240*320 px
        layoutDescs_mText11.add(new LayoutDesc(12, 500.0f, 1930.37f, LayoutDesc.NO_VALUE, 562.90f, 41.0f));  // 1080*1920 px
        layoutDescs_mText11.add(new LayoutDesc(8, 281.0f, 1085.26f, LayoutDesc.NO_VALUE, 316.48f, 26.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText12.add(new LayoutDesc(10, 518.0f, 1528.68f, LayoutDesc.NO_VALUE, 446.29f, 34.0f));  // 720*1280 px
        layoutDescs_mText12.add(new LayoutDesc(2, 225.0f, 660.65f, LayoutDesc.NO_VALUE, 193.98f, 19.0f));  // 240*320 px
        layoutDescs_mText12.add(new LayoutDesc(12, 654.0f, 1930.37f, LayoutDesc.NO_VALUE, 562.90f, 41.0f));  // 1080*1920 px
        layoutDescs_mText12.add(new LayoutDesc(8, 367.0f, 1086.26f, LayoutDesc.NO_VALUE, 316.48f, 26.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText13.add(new LayoutDesc(10, 37.0f, 1572.68f, LayoutDesc.NO_VALUE, 645.66f, 51.0f));  // 720*1280 px
        layoutDescs_mText13.add(new LayoutDesc(2, 16.0f, 680.65f, LayoutDesc.NO_VALUE, 280.64f, 25.0f));  // 240*320 px
        layoutDescs_mText13.add(new LayoutDesc(12, 46.0f, 1985.37f, LayoutDesc.NO_VALUE, 814.37f, 63.0f));  // 1080*1920 px
        layoutDescs_mText13.add(new LayoutDesc(8, 26.0f, 1117.26f, LayoutDesc.NO_VALUE, 457.87f, 38.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mImage3.add(new LayoutDesc(10, 76.0f, 1634.68f, LayoutDesc.NO_VALUE, 260.0f, 145.0f));  // 720*1280 px
        layoutDescs_mImage3.add(new LayoutDesc(2, 33.0f, 706.65f, LayoutDesc.NO_VALUE, 113.0f, 63.0f));  // 240*320 px
        layoutDescs_mImage3.add(new LayoutDesc(12, 95.0f, 2064.37f, LayoutDesc.NO_VALUE, 327.0f, 182.0f));  // 1080*1920 px
        layoutDescs_mImage3.add(new LayoutDesc(8, 54.0f, 1161.26f, LayoutDesc.NO_VALUE, 184.0f, 103.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText14.add(new LayoutDesc(10, 76.0f, 1780.68f, LayoutDesc.NO_VALUE, 259.89f, 40.0f));  // 720*1280 px
        layoutDescs_mText14.add(new LayoutDesc(2, 33.0f, 770.65f, LayoutDesc.NO_VALUE, 112.96f, 21.0f));  // 240*320 px
        layoutDescs_mText14.add(new LayoutDesc(12, 96.0f, 2248.37f, LayoutDesc.NO_VALUE, 327.79f, 49.0f));  // 1080*1920 px
        layoutDescs_mText14.add(new LayoutDesc(8, 54.0f, 1265.26f, LayoutDesc.NO_VALUE, 184.3f, 30.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText15.add(new LayoutDesc(10, 74.0f, 1814.68f, LayoutDesc.NO_VALUE, 262.59f, 84.0f));  // 720*1280 px
        layoutDescs_mText15.add(new LayoutDesc(2, 32.0f, 785.65f, LayoutDesc.NO_VALUE, 114.13f, 42.0f));  // 240*320 px
        layoutDescs_mText15.add(new LayoutDesc(12, 93.0f, 2291.37f, LayoutDesc.NO_VALUE, 331.20f, 104.0f));  // 1080*1920 px
        layoutDescs_mText15.add(new LayoutDesc(8, 53.0f, 1289.26f, LayoutDesc.NO_VALUE, 186.21f, 62.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText16.add(new LayoutDesc(10, 73.0f, 1889.68f, LayoutDesc.NO_VALUE, 262.49f, 40.0f));  // 720*1280 px
        layoutDescs_mText16.add(new LayoutDesc(2, 32.0f, 820.65f, LayoutDesc.NO_VALUE, 114.09f, 36.0f));  // 240*320 px
        layoutDescs_mText16.add(new LayoutDesc(12, 92.0f, 2386.37f, LayoutDesc.NO_VALUE, 331.08f, 49.0f));  // 1080*1920 px
        layoutDescs_mText16.add(new LayoutDesc(8, 52.0f, 1343.26f, LayoutDesc.NO_VALUE, 186.15f, 30.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText17.add(new LayoutDesc(10, 74.0f, 1926.68f, LayoutDesc.NO_VALUE, 259.98f, 40.0f));  // 720*1280 px
        layoutDescs_mText17.add(new LayoutDesc(2, 32.0f, 851.65f, LayoutDesc.NO_VALUE, 113.0f, 21.0f));  // 240*320 px
        layoutDescs_mText17.add(new LayoutDesc(12, 93.0f, 2432.37f, LayoutDesc.NO_VALUE, 327.91f, 49.0f));  // 1080*1920 px
        layoutDescs_mText17.add(new LayoutDesc(8, 52.0f, 1369.26f, LayoutDesc.NO_VALUE, 184.37f, 30.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mHotspot.add(new LayoutDesc(10, 67.0f, 1629.68f, LayoutDesc.NO_VALUE, 268.20f, 338.60f));  // 720*1280 px
        layoutDescs_mHotspot.add(new LayoutDesc(2, 29.0f, 722.65f, LayoutDesc.NO_VALUE, 116.57f, 147.17f));  // 240*320 px
        layoutDescs_mHotspot.add(new LayoutDesc(12, 84.0f, 2057.37f, LayoutDesc.NO_VALUE, 338.28f, 427.08f));  // 1080*1920 px
        layoutDescs_mHotspot.add(new LayoutDesc(8, 47.0f, 1158.26f, LayoutDesc.NO_VALUE, 190.20f, 240.12f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mImage4.add(new LayoutDesc(10, 383.0f, 1635.29f, LayoutDesc.NO_VALUE, 256.0f, 145.0f));  // 720*1280 px
        layoutDescs_mImage4.add(new LayoutDesc(2, 167.0f, 724.83f, LayoutDesc.NO_VALUE, 111.0f, 63.0f));  // 240*320 px
        layoutDescs_mImage4.add(new LayoutDesc(12, 483.0f, 2064.45f, LayoutDesc.NO_VALUE, 322.0f, 182.0f));  // 1080*1920 px
        layoutDescs_mImage4.add(new LayoutDesc(8, 272.0f, 1162.38f, LayoutDesc.NO_VALUE, 181.0f, 103.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText18.add(new LayoutDesc(10, 379.0f, 1779.29f, LayoutDesc.NO_VALUE, 257.39f, 40.0f));  // 720*1280 px
        layoutDescs_mText18.add(new LayoutDesc(2, 165.0f, 787.83f, LayoutDesc.NO_VALUE, 111.87f, 21.0f));  // 240*320 px
        layoutDescs_mText18.add(new LayoutDesc(12, 478.0f, 2245.45f, LayoutDesc.NO_VALUE, 324.64f, 49.0f));  // 1080*1920 px
        layoutDescs_mText18.add(new LayoutDesc(8, 269.0f, 1264.38f, LayoutDesc.NO_VALUE, 182.53f, 30.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText1.add(new LayoutDesc(10, 379.0f, 1814.29f, LayoutDesc.NO_VALUE, 254.80f, 201.0f));  // 720*1280 px
        layoutDescs_mText1.add(new LayoutDesc(2, 165.0f, 802.83f, LayoutDesc.NO_VALUE, 110.75f, 114.0f));  // 240*320 px
        layoutDescs_mText1.add(new LayoutDesc(12, 479.0f, 2289.45f, LayoutDesc.NO_VALUE, 321.37f, 251.0f));  // 1080*1920 px
        layoutDescs_mText1.add(new LayoutDesc(8, 269.0f, 1289.38f, LayoutDesc.NO_VALUE, 180.69f, 146.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText20.add(new LayoutDesc(10, 381.0f, 2005.29f, LayoutDesc.NO_VALUE, 446.29f, 40.0f));  // 720*1280 px
        layoutDescs_mText20.add(new LayoutDesc(2, 165.0f, 908.83f, LayoutDesc.NO_VALUE, 193.98f, 21.0f));  // 240*320 px
        layoutDescs_mText20.add(new LayoutDesc(12, 480.0f, 2529.45f, LayoutDesc.NO_VALUE, 562.90f, 49.0f));  // 1080*1920 px
        layoutDescs_mText20.add(new LayoutDesc(8, 270.0f, 1426.38f, LayoutDesc.NO_VALUE, 316.48f, 30.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mText21.add(new LayoutDesc(10, 381.0f, 2039.29f, LayoutDesc.NO_VALUE, 260.01f, 40.0f));  // 720*1280 px
        layoutDescs_mText21.add(new LayoutDesc(2, 166.0f, 923.83f, LayoutDesc.NO_VALUE, 113.01f, 21.0f));  // 240*320 px
        layoutDescs_mText21.add(new LayoutDesc(12, 481.0f, 2572.45f, LayoutDesc.NO_VALUE, 327.95f, 49.0f));  // 1080*1920 px
        layoutDescs_mText21.add(new LayoutDesc(8, 270.0f, 1450.38f, LayoutDesc.NO_VALUE, 184.39f, 30.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mHotspot2.add(new LayoutDesc(10, 373.0f, 1628.29f, LayoutDesc.NO_VALUE, 269.52f, 445.48f));  // 720*1280 px
        layoutDescs_mHotspot2.add(new LayoutDesc(2, 162.0f, 745.83f, LayoutDesc.NO_VALUE, 117.15f, 193.63f));  // 240*320 px
        layoutDescs_mHotspot2.add(new LayoutDesc(12, 471.0f, 2054.45f, LayoutDesc.NO_VALUE, 339.94f, 561.88f));  // 1080*1920 px
        layoutDescs_mHotspot2.add(new LayoutDesc(8, 265.0f, 1159.38f, LayoutDesc.NO_VALUE, 191.13f, 315.91f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mHotspot2.get(0).offsetInFlow = -444.67f;
        layoutDescs_mHotspot2.get(1).offsetInFlow = -193.27f;
        layoutDescs_mHotspot2.get(2).offsetInFlow = -560.85f;
        layoutDescs_mHotspot2.get(3).offsetInFlow = -315.33f;
        ...
        layoutDescs_mFixedButton.add(new LayoutDesc(10, 252.0f, 2089.77f, LayoutDesc.NO_VALUE, 212.52f, 63.76f));  // 720*1280 px
        layoutDescs_mFixedButton.add(new LayoutDesc(2, 110.0f, 946.45f, LayoutDesc.NO_VALUE, 92.37f, 27.71f));  // 240*320 px
        layoutDescs_mFixedButton.add(new LayoutDesc(12, 318.0f, 2637.34f, LayoutDesc.NO_VALUE, 268.05f, 80.41f));  // 1080*1920 px
        layoutDescs_mFixedButton.add(new LayoutDesc(8, 179.0f, 1487.30f, LayoutDesc.NO_VALUE, 150.71f, 45.21f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
