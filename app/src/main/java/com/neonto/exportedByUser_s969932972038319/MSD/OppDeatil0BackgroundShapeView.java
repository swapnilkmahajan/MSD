...
public class OppDeatil0BackgroundShapeView extends View {



    public OppDeatil0BackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public OppDeatil0BackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public OppDeatil0BackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
