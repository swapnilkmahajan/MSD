...
public class Search1BackgroundShapeView extends View {



    public Search1BackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public Search1BackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public Search1BackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
