...
public class OppDetail3Image4View extends FrameLayout {



    private ImageView m_image;
    // This value represents scaling applied to the image by Neonto Studio on export.
    private float m_contentOriginalScale = 0.172022684f;
    

    private boolean m_imageOverriden = false;

    public OppDetail3Image4View(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public OppDetail3Image4View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public OppDetail3Image4View(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.opp_detail3_image4);
